    ...
    {  
        ...
        {  
            ...
            {  
                ...
                //return Regex.Replace(result, @"[u0000-u0008u000Bu000Cu000E-u001AuD800-uDFFF]", delegate(Match m) { int code = (int)m.Value.ToCharArray()[0]; return (code > 9 ? "&#" + code.ToString() : "&#0" + code.ToString()) + ";"; });  
            }  
        }  
